        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 flex items-center justify-center">
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                <label htmlFor="confirm-password" className="block text-gray-700 mb-2">Password</label>
                <input
                  type="password"
                  id="confirm-password"
                  className="w-full p-3 border border-gray-300 rounded"
            ...
            <div className="mt-4 text-center">
              <p>Already have? <Link to="/login" className="text-blue-900 font-bold">Login Here</Link></p>
            </div>
